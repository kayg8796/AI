...
:- differentiate(x, D).
:- differentiate(x+7, D).
:- differentiate(x*sin(x), D).
:- differentiate(4*x^3+5*x^2, D).
:- differentiate(3*x^2*sin(x), D).
:- differentiate(3*x^2+x/sin(x), D).
:- differentiate(x*exp(x), D).
:- differentiate(log(x^2+5*x), D).
:- differentiate(sin(x)^2+cos(x)^2, D).
:- differentiate((x^3-exp(x))/(-(log(x)+7*x)), D).
